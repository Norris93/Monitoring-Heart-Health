...
heart1 <- read_csv("heart_failure_clinical_records_dataset.csv", col_types = "nfnfnfnnnffnf")

heart <- read_csv("heart_failure_clinical_records_dataset.csv", col_types = "nfnfnfnnnffnn")
```
